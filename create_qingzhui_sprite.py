...
"""
创建青骓精灵图
从176帧中选择48帧，创建8x6布局的精灵图
"""

from PIL import Image
import os

def create_qingzhui_sprite():
    # 源文件夹
    source_dir = "/Users/xiaobai/pr/11"

    # 输出文件
    output_file = "/Users/xiaobai/Desktop/Premium Horse Racing DApp UI (Copy) 2/public/horse-sprite-qingzhui.png"
    ...
    print(f"\n精灵图参数：")
    print(f"- 文件名: horse-sprite-qingzhui.png")
