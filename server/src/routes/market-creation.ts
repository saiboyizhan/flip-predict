...
const VALID_CATEGORIES = [
  'flap', 'four-meme', 'versus', 'trending', 'ai', 'sports', 'news', 'other'
];
...
router.post('/create', authMiddleware, async (req: AuthRequest, res: Response) => {
  try {
    ...
    try {
      ...
      `, [marketId, parsedOnChainMarketId, normalizedTitle, normalizedDescription, normalizedCategory || 'flap', Math.floor(endTimeMs), Math.floor(now), finalInitialLiquidity, virtualLpShares]);
