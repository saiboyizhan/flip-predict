  ...
  return (
    <div className="relative min-h-screen p-4 sm:p-8">
      ...
      <div className="relative max-w-4xl mx-auto space-y-4">
          ...
          {referralLoading ? (
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="flex-1 bg-card border border-border px-3 py-2 font-mono text-blue-400 text-sm">
                  {referral.code}
                </div>
                <button
                  onClick={copyReferralCode}
                  className="px-3 py-2 bg-blue-500 hover:bg-blue-400 text-black font-semibold text-sm transition-colors flex items-center gap-1.5"
                >
        ...
        >
          <h3 className="text-sm font-bold mb-3">{t('rewards.rewardsList')}</h3>
          ...
          {loading ? (
            ...
            <div className="bg-card/50 border border-border border-dashed p-8 text-center">
