...
"""
创建拳毛騧精灵图
从175帧中选择48帧，创建8x6布局的精灵图
"""

from PIL import Image
import os

def create_quanmaogua_sprite():
    # 源文件夹
    source_dir = "/Users/xiaobai/pr/12"

    # 输出文件
    output_file = "/Users/xiaobai/Desktop/Premium Horse Racing DApp UI (Copy) 2/public/horse-sprite-quanmaogua.png"
    ...
    print(f"\n精灵图参数：")
    print(f"- 文件名: horse-sprite-quanmaogua.png")
    print(f"- 帧宽: {frame_width}")
    print(f"- 帧高: {frame_height}")
    print(f"- 帧数: 48")
    print(f"- 布局: 8x6 (8列6行)")
    print(f"- FPS建议: 8-12 (4K需要较低FPS)")

if __name__ == "__main__":
    create_quanmaogua_sprite()
